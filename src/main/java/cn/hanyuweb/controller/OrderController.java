...
public class OrderController {
	...
	public String save_order(@ModelAttribute("order") OBJECT_T_MALL_ORDER order,HttpSession session,int address_id){
		T_MALL_USER_ACCOUNT user = (T_MALL_USER_ACCOUNT)session.getAttribute("user");
		orderServiceInf.save_order(order,addressServerInf.get_address(address_id));
